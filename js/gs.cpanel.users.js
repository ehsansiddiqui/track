...
function userEdit(cmd)
{
	switch (cmd)
	{
		default:
			...
			$.ajax({
				...
				{					
					...
					document.getElementById('dialog_user_edit_account_dashboard').value = privileges['dashboard'];
					...
					document.getElementById('dialog_user_edit_account_expenses').value = privileges['expenses'];
		...
		case "save":
			...
			var dashboard = strToBoolean(document.getElementById('dialog_user_edit_account_dashboard').value);
			...
			var expenses = strToBoolean(document.getElementById('dialog_user_edit_account_expenses').value);
